...
class NoteCard extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Card className={classes.cardWrapper} style={{backgroundColor:'#aed581'}}>
                ...
                <Dialog open={this.state.open}>
                    ...
                    <DialogContent>
                        <TextField id="standard-basic" label="Enter your note" style={{ width: "500px" }} value={this.state.note} onChange={this.handleOnChange} />
                    </DialogContent>
                    <DialogActions>
